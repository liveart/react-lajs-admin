                ...
                <div className='form-group'>
                  ...
                  <div className='col-md-9'>
                    <input type='text' className='form-control'
                      ...
                      onChange={e => this.props.setEditingObjectProperty('colors', { ...this.props.objectHolder.colors, url: e.target.value })} />
                  </div>
                </div>
                <div className='form-group'>
                  <div className='col-md-3'>
                  ...
                  <div className='col-md-9'>
                    <input type='text' className='form-control'
                      ...
                      onChange={e => this.props.setEditingObjectProperty('colors', { ...this.props.objectHolder.colors, pantones_url: e.target.value })} />
                  </div>
                </div>
              </div>
            </div>
